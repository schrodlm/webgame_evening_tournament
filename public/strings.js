...
const STR = {
  ...
  catGeo: '🌍 Geo & trivia',
  catDrawing: '🎨 Drawing',
  catDeduction: '🕵️ Social deduction',
  catWiki: '📖 Wiki racing',
  ...
  roundLiveHint: 'Everyone joins, plays, then the host enters the results here.',
  ...
  upNextNoLinkHostHint: 'No lobby link needed - start the round when everyone is ready.',
  upNextNoLinkPlayerHint: 'No lobby link for this one - get ready',
  noLinkHint: '🎯 No lobby link for this one - just play!',
  ...
  hostPickHostHint: 'Pick the next game - tap a tile in the pool below.',
  hostPickPlayerHint: 'The host is picking the next game…',
  voteLabel: 'ROUND {n} · 🗳️ VOTE',
  voteHeading: 'Vote for the next game',
  voteHint: 'Tap a game tile in the pool below{changeNote}. <b>{voted}/{total}</b> voted.',
  ...
  startNoLinkHeading: '🎛️ Host - start {game}',
