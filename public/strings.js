...
const STR = {
  ...
  createHeading: 'Start a tournament night',
  tournamentNameLabel: 'Tournament name',
  tournamentNamePlaceholder: 'Friday Night Showdown',
  nicknameLabel: 'Your nickname',
  nicknamePlaceholder: 'matej',
  pickModeLegend: 'How is the next game picked?',
  pickModeChanceOption: '🎰 Chance — spin the carousel, fate decides',
  pickModeHostOption: '🎛 Host picks — you choose every round',
  pickModeVoteOption: '🗳 Players vote — majority wins, ties go to chance',
  ...
  allPlayedBody: 'That was the night — the standings are final{extra}.',
